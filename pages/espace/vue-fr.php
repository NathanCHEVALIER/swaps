		...
		<script type="text/javascript" >
		    $(function() {
				...
				$('#bouton_changement_photo_couverture').click(function() {
				    $('#cadre_post_view').css('display','inline-block');
				    $('#cadre_post_view').fadeIn(1000);
				    $('body').css('overflow', 'hidden');
				    $('.zone_de_texte_view').load('trait_new_photo.php', { type: 'couv'});
				});
				...
				$('#bouton_changement_photo_profil').click(function() {
				    ...
				    $('#cadre_post_view').fadeIn(1000);
				    $('body').css('overflow', 'hidden');
				    $('.zone_de_texte_view').load('trait_new_photo.php', { type: 'profil'});
				});

				$("#croix_close_post").click(function() {
				    $('#cadre_post_view').hide();
				    $('#cadre_post_view').css('display','none');
